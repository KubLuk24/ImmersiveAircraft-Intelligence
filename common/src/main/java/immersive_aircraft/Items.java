...
public interface Items {
    ...
    Supplier<Item> AUTONOMOUS_BIPLANE = register("autonomous_biplane", () -> new AircraftItem(baseProps().stacksTo(1), world -> new AutonomousBiplaneEntity(Entities.AUTONOMOUS_BIPLANE.get(), world)));
