...
public interface Items {
    ...
    Supplier<Item> INTELLIGENT_BIPLANE = register("intelligent_biplane", () -> new AircraftItem(baseProps().stacksTo(1), world -> new IntelligentBiplaneEntity(Entities.INTELLIGENT_BIPLANE.get(), world)));
